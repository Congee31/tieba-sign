...
class tieba:
    # bduss
    bduss = 'NCRkJ6ME5qQXNBUXF5RzY1MlJrUlRqeFQ0dXZzcDhuQ3pqMVVaMnBSQTVvSHRoRVFBQUFBJCQAAAAAAQAAAAEAAACPOXM5Q29uZ2VlMTMAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADkTVGE5E1RheV'
    # 填入自己的百度id
    myid = 'Congee13'
